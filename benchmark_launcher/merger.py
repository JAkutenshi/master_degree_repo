        ...
        for table in tables:
            ...
            for plot in table_config["plots"]:
                ...
                for index_measure in range(0, len(plot["measures"])):
                    ...
                    if index_measure == 0:
                        r_plot += "plot(" + factor_name + ", " + measure["name"]
                        r_plot += ", type=\"" + measure["type"] + "\", col=\"" + measure["col"] + "\", lty=" + measure["lty"] + ", "
                        ...
                        r_plot += "points(" + factor_name + ", " + measure["name"] + ", "
                        r_plot += "col=\"" + measure["col"] + "\", pch=\"" + measure["type"] + "\")\n"
                        r_plot += "lines(" + factor_name + ", " + measure["name"] + ", "
                        r_plot += "col=\"" + measure["col"] + "\", lty=" + measure["lty"] + ")\n"
                    ...
                    if plot["values"] == "True":
                        r_plot += "text(" + factor_name + ", " + measure["name"] + ", labels=" + measure["name"] + ", cex= 0.7, pos=3)\n"
